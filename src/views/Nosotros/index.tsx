...
import { InfoNosotros } from '../../interface';
import styles from './styles/Nosotros.module.css';

const Nosotros = () => {
	const [infoNosotros, setInfoNosotros] = useState<Array<InfoNosotros>>([]);
	...
	const dato = infoNosotros.find((dato) => dato);
