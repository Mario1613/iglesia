        ...
        <div className={styles.container}>
          <div className={styles.vertical}>
            ...
            <div className={styles.icon}>
              ...
              <a
                href="https://www.youtube.com/channel/UC1OYQMiIqQI9kB6X5tEEb4g/videos"
                title="Youtube"
                >
                <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill='red' className="red bi bi-youtube" viewBox="0 0 16 16">
