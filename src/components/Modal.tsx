      ...
      <Overlay>
        <ContainerModal>
          <HeaderModal>
            ...
            <a className={styles.btnModal} style={{background:'#A3CCEA'}}  href="https://www.facebook.com/mario.cortezcortes/">Zelle
            <br/>
            <b style={{color:'#000', fontSize:'.7rem'}}>Para los EE.UU</b></a>
